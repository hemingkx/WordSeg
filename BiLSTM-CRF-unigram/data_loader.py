...
class SegDataset(Dataset):
    ...
    def preprocess(self, words, labels):
        ...
        for (word, label) in zip(words, labels):
            ...
            processed.append((unigram_id, label_id))
    ...
    def collate_fn(self, batch):
        ...
        uni_ids, label_ids, input_mask = self.get_long_tensor(words, labels, batch_size)

        return [uni_ids, label_ids, input_mask, lens]
